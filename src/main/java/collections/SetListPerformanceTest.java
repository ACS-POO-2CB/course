...
public class SetListPerformanceTest {
    public static void main(String[] args) {
        ...
        System.out.println("Time for hash set is " + getTestTime(set1, 60000) + " milliseconds.");

        Collection<Integer> set2 = new LinkedHashSet<Integer>();
        System.out.println("Time for linked hash set is " + getTestTime(set2, 60000) + " milliseconds.");

        Collection<Integer> set3 = new TreeSet<Integer>();
        System.out.println("Time for tree set is " + getTestTime(set3, 60000) + " milliseconds.");
